...
<head>
  ...
  overflow: hidden;
  z-index: 0;
  background-image: url('Wireless Network Pirating.jpg'); /* Set the image as a background */
...
<body>
  ...
  <main class="content">
    <section>
      <h2 style="text-align: center;padding-left: 2%;">Introduction to  Wireless Network Pirating</h2>
      <p>
        As wireless internet becomes the backbone of modern connectivity, wireless network pirating—the unauthorized use or hijacking of a Wi-Fi network—has grown into a serious cybersecurity concern. Whether in homes, businesses, or public places, unsecured or poorly protected Wi-Fi networks can be exploited by attackers to access data, spy on communications, or commit cybercrimes under someone else’s connection.
      <br><br>What makes wireless network pirating particularly dangerous is its stealth and ease of access. Attackers don’t need physical contact—they just need to be within range. Once connected, they can monitor traffic, steal sensitive information, or launch attacks on devices connected to the same network. Worse, you might not even know your network is being misused.
      <br><br>This section will help you understand how wireless network pirating works, the purposes it serves for attackers, and how to secure your network effectively.
      </p>

      <h1>How Wireless Network Pirating Is Used? </h1>
      <p style="text-align: center;"></p>

      <div class="step-container">
        <div class="step">
            <div class="step-content">
                <p class="step-title" style="font-size: 30px;"><strong>Unauthorized Internet Access</strong></p>
                <p class="step-description" style="text-align: center;">Attackers use your internet connection for free, slowing down your bandwidth and evading tracking.</p>
            </div>
        </div>
    
        <div class="step">
            <div class="step-content">
                <p class="step-title" style="font-size: 30px;"><strong> Data Interception (Sniffing)</strong></p>
                <p class="step-description" style="text-indent: 0;">Once on your network, attackers can monitor traffic and steal sensitive information like passwords or credit card numbers.</p>
            </div>
        </div>
    
        <div class="step">
            <div class="step-content">
                <p class="step-title" style="font-size: 30px;"><strong>Malware Injection</strong></p>
                <p class="step-description" style="text-align: center;">Hackers can exploit connected devices or routers to install malware on your system.</p>
            </div>
        </div>

        <div class="step">
          <div class="step-content">
              <p class="step-title" style="font-size: 30px;"><strong>  Launching Cyberattacks</strong></p>
              <p class="step-description" style="text-align: center;">Your network can be used as a base to attack others, hiding the attacker’s real identity.</p>
          </div>
      </div>

      <div class="step">
        <div class="step-content">
            <p class="step-title" style="font-size: 30px;"><strong> Accessing Personal Files or Devices</strong></p>
            <p class="step-description" style="text-align: center;">Unsecured networks may expose shared folders, printers, or even webcams to intruders.</p>
        </div>
    </div>

    <div class="step">
      <div class="step-content">
          <p class="step-title" style="font-size: 30px;"><strong>Legal and Privacy Risks</strong></p>
          <p class="step-description" style="text-align: center;">If illegal activity is conducted on your network, you could be held accountable.</p>
      </div>
  </div>
    ...
    <div class="step-container">
        <div class="step">
            ...
            <p class="step-title" style="padding-top: 1px;">Use strong Wi-Fi passwords (WPA2/WPA3 encryption).</p>
        </div>

        <div class="step">
          <div class="number-circle">2</div>
            <p class="step-title"  style="padding-top: 1px;">Change default router settings (username/password).</p>
        </div>

        <div class="step">
            <div class="number-circle">3</div>
            <p class="step-title"  style="padding-top: 1px;"> Disable remote access to your router.</p>
        </div>

        <div class="step">
          <div class="number-circle">4</div>
          <p class="step-title"  style="padding-top: 1px;">Hide your SSID or set it to private.</p>
      </div>

      <div class="step">
        <div class="number-circle">5</div>
        <p class="step-title" style="padding-top: 1px;"> Enable firewall and firmware updates.</p>
    </div>

    <div class="step">
      <div class="number-circle">6</div>
      <p class="step-title" style="padding-top: 1px;">  Monitor connected devices regularly.</p>
  </div>
  <?php
try {
  $stmt = $pdo->query("SELECT * FROM pirating_tips ORDER BY created_at ASC");
  ...
  while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
      ...
      echo '<a href="edit_pirating.php?id=' . $row['id'] . '"><button>Edit</button></a> ';
      echo '<a href="delete_pirating.php?id=' . $row['id'] . '" onclick="return confirm(\'Are you sure you want to delete this tip?\');"><button>Delete</button></a>';
      echo '</div>';
      echo '</div>';
  }
...
<div id="addTipButtonContainer" style="margin-top: -40px;">
  <a href="add_pirating.php"><button id="addTipButton">Add a Safety Tip</button></a>
</div>
