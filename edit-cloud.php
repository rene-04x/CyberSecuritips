...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($tip)) {
        $sql = "UPDATE cloud_tips SET tip_text = :tip WHERE id = :id";
    ...
    // Get existing tip
    $stmt = $pdo->prepare("SELECT tip_text FROM cloud_tips WHERE id = :id");
    $stmt->execute(['id' => $id]);
...
<body>
    <div class="container">
        ...
        <p><a href="cloud.php">Back to Safety Tips</a></p>
    </div>
</body>
</html>
