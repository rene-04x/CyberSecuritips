...
<head>
  ...
  overflow: hidden;
  z-index: 0;
  background-image: url('Phishing Attacks Growing Concern for Internet Users.jpg'); /* Set the image as a background */
...
<body>
  ...
  <main class="content">
    <section>
      <h2 style="padding-left: 10%;">Introduction to Phishing Attacks</h2>
      <p>
        In the digital era, where communication happens primarily through emails, messages, and online platforms, phishing attacks have emerged as one of the most deceptive and widespread forms of cybercrime. Phishing is a technique where attackers impersonate legitimate entities to trick individuals into revealing sensitive information such as passwords, credit card numbers, or personal data.
      <br><br>What makes phishing especially dangerous is its reliance on social engineering—manipulating human psychology rather than exploiting technical vulnerabilities. A phishing email may look like it’s from your bank, a trusted company, or even a colleague, urging you to click a link, download a file, or log in to a fake website. Once you fall for it, the attacker can steal credentials, install malware, or hijack accounts.
      <br><br>This section will help you recognize the tactics behind phishing attacks, how attackers use them, and simple yet effective ways to protect yourself.
      </p>

      <h1>How Phishing Attacks Are Used? </h1>
      <p style="text-align: center;"></p>

      <div class="step-container">
        <div class="step">
            <div class="step-content">
                <p class="step-title"style="font-size: 30px;"><strong>Credential Theft</strong></p>
                <p class="step-description" style="text-align: center;">Fake login pages are used to harvest usernames and passwords from victims.</p>
            </div>
        </div>
    
        <div class="step">
            <div class="step-content">
                <p class="step-title" style="font-size: 30px;"><strong>Financial Scams</strong></p>
                <p class="step-description" style="text-align: center;">Phishing emails may trick users into sending money, gift cards, or sensitive financial information.</p>
            </div>
        </div>
    
        <div class="step">
            <div class="step-content">
                <p class="step-title" style="font-size: 30px;"><strong>Malware Delivery</strong></p>
                <p class="step-description" style="text-align: center;">Clicking links or downloading attachments can install spyware, ransomware, or keyloggers.</p>
            </div>
        </div>

        <div class="step">
          <div class="step-content">
              <p class="step-title" style="font-size: 30px;"><strong> Business Email Compromise (BEC)</strong></p>
              <p class="step-description" style="text-align: center;">Attackers impersonate executives or vendors to deceive employees into transferring funds or data.</p>
          </div>
      </div>

      <div class="step">
        <div class="step-content">
            <p class="step-title" style="font-size: 30px;"><strong> Identity Theft and Fraud</strong></p>
            <p class="step-description" style="text-align: center;">Stolen personal data can be used to open fraudulent accounts or commit identity-based crimes.</p>
        </div>
    </div>

    <div class="step">
      <div class="step-content">
          <p class="step-title" style="font-size: 30px;"><strong>Data Breaches</strong></p>
          <p class="step-description" style="text-align: center;">Phishing can be the entry point for attackers to infiltrate networks and exfiltrate data.</p>
      </div>
  </div>
    ...
    <div class="step-container">
        <div class="step">
            ...
            <p class="step-title" style="padding-top: 1px;">Think before you click — hover over links to verify authenticity.</p>
        </div>

        <div class="step">
          <div class="number-circle">2</div>
            <p class="step-title" style="padding-top: 1px;">Check sender email addresses carefully.</p>
        </div>

        <div class="step">
            <div class="number-circle">3</div>
            <p class="step-title" style="padding-top: 1px;"> Don’t download unknown attachments.</p>
        </div>

        <div class="step">
          <div class="number-circle">4</div>
          <p class="step-title" style="padding-top: 1px;">Use spam filters and email security tools.</p>
      </div>

      <div class="step">
        <div class="number-circle">5</div>
        <p class="step-title" style="padding-top: 1px;"> Never share credentials via email or messages.</p>
    </div>

    <div class="step">
      <div class="number-circle">6</div>
      <p class="step-title" style="padding-top: 1px;">  Report suspicious messages to your IT/security team.</p>
  </div>
  <?php
try {
  $stmt = $pdo->query("SELECT * FROM phishing_tips ORDER BY created_at ASC");
  ...
  while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
      ...
      echo '<a href="edit_phishing.php?id=' . $row['id'] . '"><button>Edit</button></a> ';
      echo '<a href="delete_phishing.php?id=' . $row['id'] . '" onclick="return confirm(\'Are you sure you want to delete this tip?\');"><button>Delete</button></a>';
      echo '</div>';
      echo '</div>';
  }
...
<div id="addTipButtonContainer" style="margin-top: -40px;">
  <a href="add_phishing.php"><button id="addTipButton">Add a Safety Tip</button></a>
</div>
