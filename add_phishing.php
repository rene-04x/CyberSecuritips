...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($tip)) {
        $sql = "INSERT INTO phishing_tips (tip_text, created_at) VALUES (:tip, NOW())";
        $stmt = $pdo->prepare($sql);
        if ($stmt->execute(['tip' => $tip])) {
            header("Location: phishing_attack.php"); // Stay on this page
            exit;
        } else {
...
<div class="container">
    ...
    <button type="submit">Submit Tip</button><br>
        ...
        <p><a href="phishing_attack.php">Back to Safety Tips</a></p>
    </div>
</body>
</html>