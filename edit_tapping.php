...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($tip)) {
        $sql = "UPDATE tapping_tips SET tip_text = :tip WHERE id = :id";
    ...
    // Get existing tip
    $stmt = $pdo->prepare("SELECT tip_text FROM tapping_tips WHERE id = :id");
    $stmt->execute(['id' => $id]);
...
<body>
    <div class="container">
        ...
        <p><a href="tapping.php">Back to Safety Tips</a></p>
    </div>
</body>
</html>
