...
<head>
  ...
  overflow: hidden;
  z-index: 0;
  background-image: url('topics_bg.jpg'); /* Set the image as a background */
...
<body>
  ...
  <main class="content">
    <section>
      ...
      <p style="text-align: center;"> This topics consist of the different types of attack that you may encounter in the future. It will help you to prevent this attacks and stay safe online.
      </p>
      </div>
