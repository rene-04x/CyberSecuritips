...
<head>
  ...
  overflow: hidden;
  z-index: 0;
  background-image: url('Attacks in the Cloud.jpg'); /* Set the image as a background */
...
<body>
  ...
  <main class="content">
    <section>
      <h2>Introduction to Attacks In The Cloud</h2>
      <p>
        As organizations and individuals increasingly migrate to cloud-based platforms for storage, communication, collaboration, and computing, the cloud has become a cornerstone of the modern digital ecosystem. While offering unmatched scalability, flexibility, and cost-efficiency, cloud computing also presents a new and expanding frontier for cyber threats. Understanding attacks in the cloud is critical—not just for IT professionals, but for anyone who relies on cloud services in their daily digital interactions.
      <br><br>Cloud environments, by their very nature, are shared, remote, and accessible from virtually anywhere. These characteristics, while advantageous, also introduce new vulnerabilities and security considerations. Attackers are quick to exploit these openings, leveraging weaknesses in cloud configurations, access controls, and user behavior to infiltrate systems, exfiltrate data, or disrupt services.
      <br><br>This section of our cybersecurity awareness resource is dedicated to demystifying cloud-based attacks. By understanding how these attacks work, why cloud platforms are attractive targets, and what makes them vulnerable, we can begin to implement effective strategies to secure our data and services in the cloud.
      </p>

      <h1>Why the Cloud is a Target?</h1>
      <p style="text-indent: 0;">
        Cloud platforms host vast amounts of sensitive data and critical services. The key factors that make cloud environments attractive targets include:
      </p>
      <ul>
        <li><strong>Centralized Value:  </strong>One compromised cloud platform may expose data from thousands of users or entire organizations.</li><br>
        <li><strong>Ease of Access:  </strong>Cloud services are accessible over the internet, increasing the risk if access is not properly secured.</li><br>
        <li><strong>Rapid Deployment:  </strong> Speed often comes at the cost of secure configuration.</li><br>
        <li><strong>Shared Responsibility Model: </strong>Misunderstanding security obligations between the cloud provider and user can leave gaps.</li><br>
        <li><strong>Third-Party Integration: </strong> Extensive use of third-party tools and services introduces additional risk vectors.</li><br>
      </ul>
      <h1>
        Understanding Cloud Attack Vectors
      </h1>
      <p>Cloud attacks take several forms, including:</p><br> 
      <ul>
      ...
      <h1>How Attacks in the Cloud Are Used? </h1>
      <p style="text-align: center;">Cybercriminals exploit cloud vulnerabilities not just for entry, but to maximize the damage, spread, and value of their attacks. Here's how cloud-based attacks are commonly used in real-world scenarios:</p>
      <div class="step-container">
        <div class="step">
            <div class="step-content">
                <p class="step-title" style="font-size: 30px;"><strong>Data Exfiltration and Sale</strong></p>
                <p class="step-description" style="text-indent: 0;">Once attackers breach a cloud storage system, they often steal sensitive data—including customer records, trade secrets, and financial information—and sell it on the dark web or use it for blackmail or competitive advantage.</p>
            </div>
        </div>
    
        <div class="step">
            <div class="step-content">
                <p class="step-title" style="font-size: 30px;"><strong>Ransomware Deployment</strong></p>
                <p class="step-description" style="text-indent: 0;">Cloud storage and SaaS applications are prime targets for ransomware. Attackers may encrypt cloud-hosted files or lock access to services, demanding payment to restore availability.</p>
            </div>
        </div>
    
        <div class="step">
            <div class="step-content">
                <p class="step-title" style="font-size: 30px;"><strong>Lateral Movement and Pivoting</strong></p>
                <p class="step-description" style="text-indent: 0;">A compromised cloud environment may serve as a gateway to deeper parts of a corporate network. Attackers use the cloud system to move laterally into on-premises infrastructure or other integrated services.</p>
            </div>
        </div>

        <div class="step">
          <div class="step-content">
              <p class="step-title" style="font-size: 30px;"><strong>Cryptojacking</strong></p>
              <p class="step-description" style="text-indent: 0;">Some attacks involve hijacking cloud computing power—especially in IaaS environments—for unauthorized cryptocurrency mining, which can go undetected while draining resources and increasing costs.</p>
          </div>
      </div>
    ...
    <div class="step">
      <div class="step-content">
          <p class="step-title" style="font-size: 30px;"><strong>Command and Control (C2) Channels</strong></p>
          <p class="step-description" style="text-indent: 0;">Attackers sometimes use legitimate-looking cloud services (e.g., file sharing apps) as C2 infrastructure to control malware on infected systems without raising suspicion.</p>
      </div>
  </div>
    ...
    <div class="step-container">
        <div class="step">
            ...
            <p class="step-title" style="padding-top: 1px;">Enable multi-factor authentication (MFA) on all cloud accounts.</p>
        </div>

        <div class="step">
          <div class="number-circle">2</div>
            <p class="step-title" style="padding-top: 1px;">Use strong, unique passwords and store them securely.</p>
        </div>

        <div class="step">
            <div class="number-circle">3</div>
            <p class="step-title" style="padding-top: 1px;">Encrypt sensitive data before uploading to cloud storage.</p>
        </div>

        <div class="step">
          <div class="number-circle">4</div>
          <p class="step-title" style="padding-top: 1px;">Regularly review app permissions and device access.</p>
      </div>

      <div class="step">
        <div class="number-circle">5</div>
        <p class="step-title" style="padding-top: 1px;">Avoid using public Wi-Fi without a secure VPN when accessing cloud platforms.</p>
    </div>
...
try {
  $stmt = $pdo->prepare("SELECT * FROM cloud_tips WHERE category = 'individual' ORDER BY created_at ASC");
  $stmt->execute();
  ...
  while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
      ...
      echo '<a href="edit-cloud.php?id=' . $row['id'] . '"><button>Edit</button></a> ';
      echo '<a href="delete_cloud.php?id=' . $row['id'] . '" onclick="return confirm(\'Are you sure you want to delete this tip?\');"><button>Delete</button></a>';
      echo '</div>';
      echo '</div>';
  }
...
?>
    ...
    <div class="step-container">
        <div class="step">
            <div class="number-circle">1</div>
            <p class="step-title" style="padding-top: 1px;">Clearly define the shared responsibility model between your team and your cloud provider.</p>
        </div>

        <div class="step">
          <div class="number-circle">2</div>
            <p class="step-title" style="padding-top: 1px;">Implement identity and access management (IAM) policies with the principle of least privilege.</p>
        </div>

        <div class="step">
            <div class="number-circle">3</div>
            <p class="step-title" style="padding-top: 1px;">Regularly audit cloud configurations and set up alerts for suspicious changes or logins.</p>
        </div>

        <div class="step">
          <div class="number-circle">4</div>
          <p class="step-title" style="padding-top: 1px;">Use encryption for data in transit and at rest in the cloud environment.</p>
      </div>

      <div class="step">
        <div class="number-circle">5</div>
        <p class="step-title" style="padding-top: 1px;">Deploy cloud security posture management (CSPM) and endpoint protection tools.</p>
    </div>

    <div class="step">
      <div class="number-circle">6</div>
      <p class="step-title" style="text-align: center;padding-top: 1px;">Educate all employees on cloud-specific phishing, social engineering, and secure sharing practices.</p>
  </div>
  <?php
try {
  $stmt = $pdo->query("SELECT * FROM cloud_tips WHERE category = 'organization' ORDER BY created_at ASC");
...
<div id="addTipButtonContainer" style="margin-top: -40px;">
  <a href="cloud_tips.php"><button id="addTipButton">Add a Safety Tip</button></a>
</div>
